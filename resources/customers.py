...
class CustomerResource(Resource):
    ...
    parser.add_argument('name',type=str,required=True,help='Name of the customer is required')
    parser.add_argument('address,',type=str,required=True,help='Address of the customer is required')
    parser.add_argument('email',type=str,reuired=True,help='Email address of the customer is required')
    parser.add_argumnet('phone',type=str,required=True,help='Enter the phone number of the customer')
